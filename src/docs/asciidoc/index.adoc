...
For users integrating this error handling library into a Spring Boot project that uses OpenAPI (Swagger) for API documentation, it is necessary to explicitly define the error response structure in API documentation.
