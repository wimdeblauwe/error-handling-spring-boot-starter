...
@ContextConfiguration(classes = {ServletErrorHandlingConfiguration.class,
        ObjectOptimisticLockingFailureApiExceptionHandlerWithProblemDetailTest.TestController.class})
@TestPropertySource(properties = "error.handling.use-problem-detail-format=true")
class ObjectOptimisticLockingFailureApiExceptionHandlerWithProblemDetailTest {
