...
|https://github.com/wimdeblauwe/error-handling-spring-boot-starter/releases/tag/5.0.0[5.0.0]
|4.0.0
|17
|https://wimdeblauwe.github.io/error-handling-spring-boot-starter/5.0.0/[Documentation 5.0.0]
