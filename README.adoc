...
|https://github.com/wimdeblauwe/error-handling-spring-boot-starter/releases/tag/5.0.0-rc.1[5.0.0-rc.1]
|4.0.0-RC1
|17
|https://wimdeblauwe.github.io/error-handling-spring-boot-starter/5.0.0-rc.1/[Documentation 5.0.0-rc.1]
