...
image:https://img.shields.io/maven-central/v/io.github.wimdeblauwe/error-handling-spring-boot-starter[Maven Central Version]

📕 Want to write production-ready Spring Boot starters like this one? Read https://www.wimdeblauwe.com/books/crafting-spring-boot-starters/[Crafting Spring Boot Starters].
...
|https://github.com/wimdeblauwe/error-handling-spring-boot-starter/releases/tag/5.1.1[5.1.1]
|4.0.x
|17
|https://wimdeblauwe.github.io/error-handling-spring-boot-starter/5.1.1/[Documentation 5.1.1]
...
|3.3.x, 3.4.x, 3.5.x
|17
|https://wimdeblauwe.github.io/error-handling-spring-boot-starter/4.6.0/[Documentation 4.6.0]
